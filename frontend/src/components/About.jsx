  ...
  return (
    <div id="about" className="w-full h-[100vh] bg-gray-700">
      <div className="relative container mx-auto flex h-[780px] px-20 gap-6">
        <div className="flex flex-col mt-16 gap-7 w-1/3">
          <div className="uniq text-4xl gap-4 tracking-widest font-extrabold mt-7 flex flex-col">
            <span>
        ...
        <div className="flex w-2/3 flex-col mt-28  ms-16 gap-5">
